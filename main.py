...
class MainWindow(QWidget):
    ...
    def save_info(self):
        try:
            camera_info = open('/home/tester/Desktop/recordingGui-master/camera_info.txt', 'w')
    ...
    def capture_buttonClick(self):
        ...
        # print(gp.check_result(gp.gp_widget_get_child_by_name(config, 'f-number')).get_value())
    ...
    def _initTableLayout(self):
        ...
        try: 
            camera_info = open('/home/tester/Desktop/recordingGui-master/camera_info.txt', 'r')
