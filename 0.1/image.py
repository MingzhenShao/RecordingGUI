...
class FocusWindow(QWidget):
    ...
    def initLayout(self):
        ...
        self.p = sp.Popen(["/home/tester/Desktop/recordingGui-master/focus.sh"], shell=True, stdout=sp.PIPE)
...
class ImageWindow(QWidget):
    ...
    def initLayout(self):
        ...
        # self.bk_2.clicked.connect(self.getbox_bk2)
        ...
        #################################
        self.cropped_scatter_label.setAlignment(QtCore.Qt.AlignCenter)
        ...
        ###############################
        imageLayout.addWidget(self.cropped_scatter_title, 2, 0)
        imageLayout.addWidget(self.cropped_scatter_label, 3, 0)
        imageLayout.addWidget(self.scatter_mask_title, 2, 1)
        imageLayout.addWidget(self.scatter_mask_label, 3, 1)

        imageLayout.addWidget(self.cnn_mask_title, 4, 0)
        imageLayout.addWidget(self.cnn_mask_label, 5, 0)
        ###############################
    ...
    def paintEvent(self, event):
        if(self.draw_en):
            ...
            pixmap = QtGui.QPixmap(self.scaled_roi_tmp.size())
            pixmap.fill(QtCore.Qt.transparent)

            painter = QtGui.QPainter(self.scaled_roi_tmp)
    ...
    # def getbox_bk2(self):
    #     self.flag = 1
    #     self.button_bk2_en = 1
    #     # self.bk2_tl = (self.roi_position - (self.size / 2)) * 6
